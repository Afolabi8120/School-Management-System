    ...
    public partial class frmExpenseReport : Form
    {
        ...
        public void LoadHeader()
        {
            ...
            if (dr.HasRows)
            {
                ...
                reportViewer1.LocalReport.ReportPath = Application.StartupPath + "/Reports/ExpenseReport.rdlc";
                ...
                rptDS = new ReportDataSource("DataSet1", ("dtExpense"));
        ...
        {
            cn.Open();
            da = new MySqlDataAdapter("SELECT * FROM tblexpense WHERE date BETWEEN '" + date1 + "' AND '" + date2 + "' ORDER BY name ASC", cn);
            DataSet1 ds = new DataSet1();
            da.Fill(ds, "dtExpense");
